<ul>
  ...
  <li>
    ...
    <ul class="nav submenu">
      <li><a href="group.php">Administar grupos</a> </li>
      <li><a href="users.php">Administar usuarios</a> </li>
   </ul>
  </li>
  <li>
  ...
  <li>
    ...
    <ul class="nav submenu">
       ...
       <li><a href="add_product.php">Agregar un producto</a> </li>
   </ul>
  </li>
  <li>
    <a href="media.php" >
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
         ...
         <li><a href="add_sale.php">Agregar una venta</a> </li>
     </ul>
  </li>
  <li>
    <a href="#" class="submenu-toggle">
